...
(function() {
  ...
  SwaggerApi = (function() {
    ...
    SwaggerApi.prototype.buildFromSpec = function(response) {
      ...
      if (response.basePath) {
        this.basePath = "http://" + window.location.hostname + ":" + window.location.port;
  ...
  SwaggerRequest = (function() {
    function SwaggerRequest(type, url, params, opts, successCallback, errorCallback, operation, execution) {
      ...
      this.serverCannotProduceTheRequestedProductType = function (formatsServerProduces, requestedResponseContentType) {
        return _.all(formatsServerProduces, function(acceptableResponseFormat){return acceptableResponseFormat.indexOf(requestedResponseContentType) === -1});
      };
